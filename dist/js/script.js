...
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
window.onload = function () {
  /* Телефонная маска */
  Object(imask__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(document.querySelector('.form-tel-input'), {
    mask: [{
  ...
  var telRegExp = /(8|\+7)\s?[ ][\(][0-9]{3}[\)][ ]{0,1}\s?\d{3}[-]{0,1}\d{2}[-]{0,1}\d{2}/;
  var form = document.querySelector('.form');
  var telInput = document.querySelector('.form-tel-input');
  var telError = document.querySelector('.form-tel-error');
  telInput.addEventListener('input', function () {
    var text = telInput.value.length !== 0 && telRegExp.test(telInput.value);
